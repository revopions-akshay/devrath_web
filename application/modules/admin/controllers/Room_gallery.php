...
class Room_gallery extends Admin_Base_Controller
{
    ...
    public function index()
    {
        try {
            ...
            $crud = $this->getGroceryCRUD('room_gallery', 'Room Gallery', 'Manage Room Gallery', 'Manage Room Gallery');
            ...
            //   $crud->required_fields('id', 'catname', 'sort', 'file_path');
              ...
              // relationship
              $crud->set_relation('catid', 'room_category', 'catname');
