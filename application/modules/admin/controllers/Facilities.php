...
class Facilities extends Admin_Base_Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $crud = $this->getGroceryCRUD('facilities', 'Facilities', 'Manage Facilities', 'Manage Facilities');

            // data Grid view fields
            $crud->columns('name', 'file', 'sort');

            // Insert form
            $crud->add_fields('name', 'file', 'sort');
            ...
            $crud->set_field_upload('file', 'assets/devrath/images/facilities');
