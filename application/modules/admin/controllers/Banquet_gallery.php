...
class Banquet_gallery extends Admin_Base_Controller
{
    ...
    public function index()
    {
        try {
            ...
            $crud = $this->getGroceryCRUD('banquet_gallery', 'Banquet Gallery', 'Manage Banquet Gallery', 'Manage Banquet Gallery');
            ...
            //File upload
            $crud->set_field_upload('file_path', 'assets/devrath/images/banquet/gallery');
    ...
    {
        $image_url = base_url('assets/devrath/images/banquet/gallery' . $value);
