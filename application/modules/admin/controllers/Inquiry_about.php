...
class Inquiry_about extends Admin_Base_Controller
{
    ...
    public function index()
    {
        try {
            ...
            $crud = $this->getGroceryCRUD('inquiry_about', 'Inquiry Inquiry', 'Manage Inquiry', 'Manage Inquiry');
           ...
           $crud->add_fields('title', 'page_breadcrumb');
            ...
            //File upload
            $crud->set_field_upload('page_breadcrumb', 'assets/devrath/images/inquiry');

            

           
            // Required fields
            // $crud->required_fields('page_breadcrumb');
    ...
    {
        $image_url = base_url('assets/devrath/images/inquiry' . $value);
