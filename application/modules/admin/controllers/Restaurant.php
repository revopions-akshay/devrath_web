...
class Restaurant extends Admin_Base_Controller
{
    ...
    public function index()
    {
        try {
            ...
            $crud = $this->getGroceryCRUD('restaurant', 'Restaurant', 'Manage Restaurant', 'Manage Restaurant');
            ...
            // Required fields
            $crud->required_fields('title_one', 'content_one', 'content_two', 'file_path_two', 'file_path');
